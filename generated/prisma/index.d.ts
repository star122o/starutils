...
export namespace Prisma {
  ...
  */
  ...
  export type WhitelistOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"userId", ExtArgs["result"]["whitelist"]>
  ...
  export interface WhitelistDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const whitelistWithUserIdOnly = await prisma.whitelist.findMany({ select: { userId: true } })
     * 
     */
  ...
  export const WhitelistOrderByRelevanceFieldEnum: {
    userId: 'userId'
  };

  export type WhitelistOrderByRelevanceFieldEnum = (typeof WhitelistOrderByRelevanceFieldEnum)[keyof typeof WhitelistOrderByRelevanceFieldEnum]
  ...
  export type WhitelistOrderByWithRelationInput = {
    userId?: SortOrder
    _relevance?: WhitelistOrderByRelevanceInput
  }
  ...
  export type WhitelistOrderByRelevanceInput = {
    fields: WhitelistOrderByRelevanceFieldEnum | WhitelistOrderByRelevanceFieldEnum[]
    sort: SortOrder
    search: string
  }
